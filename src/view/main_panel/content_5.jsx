...
class Content5 extends React.Component { 
    ...
    onStatisticsSelected() {
        this.setState({mode: this.MODE_STATISTICS});
    }
    ...
    renderContent() {
        return this.state.mode == this.MODE_CONNECTIONS ? this.renderNoConnections() : this.renderStatistics();
    }
        ...
        return (
            <div className="main_content_5">
                <Label 
                    ...
                    text={this.state.mode == this.MODE_CONNECTIONS ? Localization.get("connections") : Localization.get("statistics")} 
                />
                {this.renderContent()}
            </div>
        );
